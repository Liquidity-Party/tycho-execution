...
impl LiquidityPartySwapEncoder {
    fn get_token_indexes(&self, swap: &Swap) -> Result<(Bytes, u8, u8), EncodingError> {
        ...
        println!("LiqP swap encoder: token_addresses={:?}", token_addresses);
...
impl SwapEncoder for LiquidityPartySwapEncoder {
    ...
    fn encode_swap(
        ...
        println!("LiqP swap encoder: swap={:?}", swap);

        let (token_in, token_in_idx, token_out_idx) = self.get_token_indexes(swap)?;

        println!("LiqP swap encoder: token_in={:?}, in_idx={}, out_idx={}", token_in, token_in_idx, token_out_idx);
...
mod tests {
    ...
    fn test_encode_liquidityparty() {
        let liqp_pool = ProtocolComponent {
            // mainnet test
            id: String::from("0xc9B0e59F2E089bFf63db5A82e91dd0a9FD504D3c"),
            tokens: [Address::from("0xdAC17F958D2ee523a2206206994597C13D831ec7"), Address::from("0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"), Address::from("0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599"), Address::from("0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2"), Address::from("0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984"), Address::from("0xD31a59c85aE9D8edEFeC411D448f90841571b89c"), Address::from("0x50327c6c5a14DCaDE707ABad2E27eB517df87AB5"), Address::from("0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9"), Address::from("0x6982508145454Ce325dDbE47a25d4ec3d2311933"), Address::from("0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE")].to_vec(),
            ..Default::default()
        };
        // Pool Tokens:
        // [0xdAC17F958D2ee523a2206206994597C13D831ec7, 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48, 0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599, 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2, 0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984, 0xD31a59c85aE9D8edEFeC411D448f90841571b89c, 0x50327c6c5a14DCaDE707ABad2E27eB517df87AB5, 0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9, 0x6982508145454Ce325dDbE47a25d4ec3d2311933, 0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE]
        ...
        assert_eq!(
            ...
            String::from(concat!(
            // pool address
            "c9b0e59f2e089bff63db5a82e91dd0a9fd504d3c", // MUST BE LOWERCASE
            // in token address
